...
Vor der Abgabe bitte die Checkliste in \texttt{docs/thesis-checklist.md} durchgehen und alle diese Hinweise entfernen.
...
\begin{ltgexample}
\zcref[S]{fig:label} zeigt etwas Interessantes
...
\begin{ltgexample}
\zcref[S]{lst:XML} zeigt XML-Quelltext.
\zcref[S]{line:comment} enthält einen Kommentar.
...
\zcref[S]{lst:flXML} zeigt das gleitendede Listing.
