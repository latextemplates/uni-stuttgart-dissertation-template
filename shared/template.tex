...
% paralist is the quasi-successor of enumitem
%   paralist enables compactenum environment
%TODO: enumitem package is now newer than paralist.
%      It enables compact enums via the global setting \setlist{noitemsep}
\usepackage{paralist}
