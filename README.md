...
```bash
npx --yes --package textlint --package textlint-plugin-latex2e --package textlint-rule-terminology --package textlint-rule-write-good textlint thesis-example.tex
```
